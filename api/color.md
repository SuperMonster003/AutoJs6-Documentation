...
colors.distance('orange', 'dark-orange'); // 8.33
...
- **colorA** { [OmniColor](omniTypes#omnicolor) } - 颜色参数
- **colorB** { [OmniColor](omniTypes#omnicolor) } - 颜色参数
- **[ ratio = `0.5` ]** { [Range[0..1]](dataTypes#range) | [PercentString](dataTypes#percentstring) } - 第二个颜色的权重
...
colors.toHex(colors.blend('red', 'blue', 0.25)); // "#BF0040"
```
...
colors.contrast('#777777', 'white') >= 4.5; // true
```
